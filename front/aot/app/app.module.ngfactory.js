...
var AppModuleInjector = (function (_super) {
    ...
    function AppModuleInjector(parent) {
        ...
        ], [import43.AppComponentNgFactory]) || this;
    }
    Object.defineProperty(AppModuleInjector.prototype, "_LOCALE_ID_9", {
        get: function () {
            if ((this.__LOCALE_ID_9 == null)) {
                (this.__LOCALE_ID_9 = import3._localeFactory(this.parent.get(import44.LOCALE_ID, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_ID_17", {
        get: function () {
            if ((this.__APP_ID_17 == null)) {
                (this.__APP_ID_17 = import45._appIdRandomProviderFactory());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_21", {
        get: function () {
            if ((this.__EventManager_21 == null)) {
                (this.__EventManager_21 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_20, this.parent.get(import48.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgProbeToken_25", {
        get: function () {
            if ((this.__NgProbeToken_25 == null)) {
                (this.__NgProbeToken_25 = [import5.routerNgProbeToken()]);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_26", {
        get: function () {
            if ((this.__RootRenderer_26 == null)) {
                (this.__RootRenderer_26 = import49._createConditionalRootRenderer(this._DomRootRenderer_24, this.parent.get(import49.NgProbeToken, null), this._NgProbeToken_25));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AnimationQueue_29", {
        get: function () {
            if ((this.__AnimationQueue_29 == null)) {
                (this.__AnimationQueue_29 = new import19.AnimationQueue(this.parent.get(import48.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_42", {
        get: function () {
            if ((this.__LocationStrategy_42 == null)) {
                (this.__LocationStrategy_42 = new import27.HashLocationStrategy(this.parent.get(import50.PlatformLocation), this.parent.get(import51.APP_BASE_HREF, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgModuleFactoryLoader_46", {
        get: function () {
            if ((this.__NgModuleFactoryLoader_46 == null)) {
                (this.__NgModuleFactoryLoader_46 = new import31.SystemJsNgModuleLoader(this._Compiler_16, this.parent.get(import31.SystemJsNgModuleLoaderConfig, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Router_49", {
        get: function () {
            if ((this.__Router_49 == null)) {
                (this.__Router_49 = import5.setupRouter(this._ApplicationRef_15, this._UrlSerializer_44, this._RouterOutletMap_45, this._Location_43, this, this._NgModuleFactoryLoader_46, this._Compiler_16, this._ROUTES_47, this._ROUTER_CONFIGURATION_48, this.parent.get(import55.UrlHandlingStrategy, null), this.parent.get(import56.RouteReuseStrategy, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ROUTER_INITIALIZER_55", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_55 == null)) {
                (this.__ROUTER_INITIALIZER_55 = import5.initialRouterNavigation(this._Router_49, this._ApplicationRef_15, this._RouterPreloader_53, this._ROUTER_CONFIGURATION_48));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EnvironmentService_57", {
        get: function () {
            if ((this.__EnvironmentService_57 == null)) {
                (this.__EnvironmentService_57 = new import33.EnvironmentService());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RestService_58", {
        get: function () {
            if ((this.__RestService_58 == null)) {
                (this.__RestService_58 = new import34.RestService(this._Http_40, this._EnvironmentService_57));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_CookieService_59", {
        get: function () {
            if ((this.__CookieService_59 == null)) {
                (this.__CookieService_59 = new import35.CookieService());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_UserService_60", {
        get: function () {
            if ((this.__UserService_60 == null)) {
                (this.__UserService_60 = new import36.UserService(this._RestService_58, this._Router_49, this._CookieService_59));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventService_61", {
        get: function () {
            if ((this.__EventService_61 == null)) {
                (this.__EventService_61 = new import37.EventService(this._RestService_58));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NavigationService_62", {
        get: function () {
            if ((this.__NavigationService_62 == null)) {
                (this.__NavigationService_62 = new import38.NavigationService());
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ApplicationRef__14 = new import12.ApplicationRef_(this.parent.get(import48.NgZone), this.parent.get(import58.Console), this, this._ErrorHandler_11, this, this._ApplicationInitStatus_12, this.parent.get(import11.TestabilityRegistry, null), this._Testability_13);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import33.EnvironmentService)) {
            return this._EnvironmentService_57;
        }
        if ((token === import34.RestService)) {
            return this._RestService_58;
        }
        if ((token === import35.CookieService)) {
            return this._CookieService_59;
        }
        if ((token === import36.UserService)) {
            return this._UserService_60;
        }
        if ((token === import37.EventService)) {
            return this._EventService_61;
        }
        if ((token === import38.NavigationService)) {
            return this._NavigationService_62;
        }
